  ...
  return (
    <section id="contact" className="scroll-mt-28 py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-4">
        <SectionHeading
          title="Get In Touch"
          subtitle="I’m open to work and collaborations. Send a message or use the links."
        />
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-md border bg-background px-3 py-2 outline-none focus:ring-2 focus:ring-ring"
                defaultValue="Haneenimam99@gmail.com"
              />
            </div>
            <div>
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-sm space-y-4 flex flex-col">
            <h4 className="font-semibold">Contact</h4>
            <a
              href="mailto:Haneenimam99@gmail.com"
              className="block text-sm text-muted-foreground hover:underline"
            >
              Email: Haneenimam99@gmail.com
            </a>
            <a
              href="tel:+201020451321"
              className="block text-sm text-muted-foreground hover:underline"
            >
              Phone: +201020451321
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="block text-sm text-muted-foreground hover:opacity-80"
            >
